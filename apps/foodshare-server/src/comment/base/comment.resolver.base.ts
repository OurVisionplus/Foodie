...
export class CommentResolverBase {
  ...
  async getMeal(@graphql.Parent() parent: Comment): Promise<Meal | null> {
    const result = await this.service.getMeal(parent.id);
