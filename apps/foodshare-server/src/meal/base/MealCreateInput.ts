...
class MealCreateInput {
  @ApiProperty({
    required: false,
    type: () => CommentCreateNestedManyWithoutMealsInput,
  })
  @ValidateNested()
  @Type(() => CommentCreateNestedManyWithoutMealsInput)
  @IsOptional()
  @Field(() => CommentCreateNestedManyWithoutMealsInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => LikeCreateNestedManyWithoutMealsInput,
  })
  @ValidateNested()
  @Type(() => LikeCreateNestedManyWithoutMealsInput)
  @IsOptional()
  @Field(() => LikeCreateNestedManyWithoutMealsInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => PaymentCreateNestedManyWithoutMealsInput,
  })
  @ValidateNested()
  @Type(() => PaymentCreateNestedManyWithoutMealsInput)
  @IsOptional()
  @Field(() => PaymentCreateNestedManyWithoutMealsInput, {
    nullable: true,
  })
